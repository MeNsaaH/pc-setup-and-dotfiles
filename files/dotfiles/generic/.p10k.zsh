# Generated by Powerlevel10k configuration wizard on 2022-07-15 at 09:16 WAT.
...
# disconnected, compact, concise, transient_prompt, instant_prompt=quiet.
...
() {
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='k|kubectl|helm|kustomize|kubens|kubectx|oc|istioctl|kogito|k9s|helmfile|flux|fluxctl|stern|kubeseal|skaffold'
  ...
  typeset -g POWERLEVEL9K_AWS_SHOW_ON_COMMAND='aws|awless|terraform|pulumi|terragrunt|tf|tg'
